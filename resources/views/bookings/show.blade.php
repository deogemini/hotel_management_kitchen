...
<div class="d-flex gap-2">
    @if(in_array($booking->status, ['Pending', 'Confirmed'], true))<form method="POST" action="{{ route('bookings.check-in', $booking) }}">@csrf<button class="btn btn-success">Check In</button></form>@endif
